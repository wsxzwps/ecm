...
tf.app.flags.DEFINE_integer("category", 7, "category of emotions.")
tf.app.flags.DEFINE_integer("num_layers", 2, "Number of layers in the model.")
tf.app.flags.DEFINE_integer("post_vocab_size", 23608, "post vocabulary size.")
tf.app.flags.DEFINE_integer("response_vocab_size", 23608, "response vocabulary size.")
